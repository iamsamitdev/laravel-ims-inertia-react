...
function Register() {
  ...
  return /* @__PURE__ */ jsxs(Guest, { children: [
    /* @__PURE__ */ jsx(Head, { title: "ลงทะเบียน" }),
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(InputLabel, { htmlFor: "name", value: "ชื่อ" }),
        /* @__PURE__ */ jsx(
          TextInput,
          {
            id: "name",
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
        /* @__PURE__ */ jsx(InputLabel, { htmlFor: "password_confirmation", value: "ยืนยันรหัสผ่าน" }),
        /* @__PURE__ */ jsx(
          TextInput,
          {
