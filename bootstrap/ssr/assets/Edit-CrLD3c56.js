...
function Edit({ auth, roles, user }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("div", { className: "row g-2 align-items-center", children: /* @__PURE__ */ jsx("div", { className: "col", children: /* @__PURE__ */ jsx("h2", { className: "page-title", children: "แก้ไขข้อมูลผู้ใช้งาน" }) }) }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: `แก้ไขข้อมูลผู้ใช้งาน: ${user.name}` }),
          ...
          /* @__PURE__ */ jsx("div", { className: "row", children: /* @__PURE__ */ jsx("div", { className: "col-12", children: /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "col-md-8", children: /* @__PURE__ */ jsxs("div", { className: "card", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "card-body", children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      ...
                      children: [
                        ...
                        roles.map((role) => /* @__PURE__ */ jsx("option", { value: role.id.toString(), children: role.name }, role.id))
                      ]
                    }
                  ),
                ...
                /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
                  /* @__PURE__ */ jsx("h4", { children: "เปลี่ยนรหัสผ่าน" }),
                  /* @__PURE__ */ jsx("p", { className: "text-muted", children: "เว้นว่างไว้หากไม่ต้องการเปลี่ยนรหัสผ่าน" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "card-footer text-end", children: [
                /* @__PURE__ */ jsx(Link, { href: route("users.show", user.id), className: "btn btn-outline-secondary me-2", children: "ยกเลิก" }),
