  ...
  return /* @__PURE__ */ jsxs(
    Authenticated,
    {
      ...
      header: /* @__PURE__ */ jsx("div", { className: "page-header d-print-none", children: /* @__PURE__ */ jsxs("div", { className: "container-xl", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "page-title", children: "แก้ไขข้อมูลซัพพลายเออร์" })
      ] }) }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: `แก้ไขซัพพลายเออร์: ${supplier.name}` }),
