    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
            <div class="container-xl">
                <div class="d-flex justify-content-between align-items-center d-md-none w-100 mb-2">
                    <button class="navbar-toggler d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu" aria-controls="navbar-menu" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <a href="{{ url('/') }}" class="d-md-none">
                        <img src="{{ asset('static/logo.svg') }}" width="110" height="32" alt="Logo" class="navbar-brand-image">
                    </a>
                </div>
                ...
                <div class="d-md-none mb-3">
                    <div class="d-flex flex-wrap justify-content-around">
                        <a href="{{ route('dashboard') }}" class="text-center p-2 mobile-quick-item {{ request()->is('dashboard*') ? 'active' : '' }}">
                            <div class="rounded-circle p-2 mb-1 mx-auto" style="background-color: rgba(32, 107, 196, 0.1); width: 40px; height: 40px;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l-2 0l9 -9l9 9l-2 0" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                            </div>
                            <div class="small">หน้าหลัก</div>
                        </a>
                        <a href="{{ route('products.index') }}" class="text-center p-2 mobile-quick-item {{ request()->is('products*') ? 'active' : '' }}">
                            <div class="rounded-circle p-2 mb-1 mx-auto" style="background-color: rgba(32, 107, 196, 0.1); width: 40px; height: 40px;">
                            ...
                            <div class="small">สินค้า</div>
                        </a>
                        <a href="{{ route('orders.index') }}" class="text-center p-2 mobile-quick-item {{ request()->is('orders*') ? 'active' : '' }}">
                            <div class="rounded-circle p-2 mb-1 mx-auto" style="background-color: rgba(32, 107, 196, 0.1); width: 40px; height: 40px;">
                            ...
                            <div class="small">คำสั่งซื้อ</div>
                        </a>
                    </div>
                </div>
